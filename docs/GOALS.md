...
**North star (NL-ADR-019):** перекрыть сильные стороны frontier **своей системой** (линейка + Synapse + контур), оставаясь непохожей породой, с **измеримой экономией ресурсов**. Не клон Kimi/Grok. Подробно: [`STRATEGY.md`](STRATEGY.md).
---
